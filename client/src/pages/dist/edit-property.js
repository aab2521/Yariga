...
var CreateProperty = function () {
    ...
    var handleImageChange = function (file) {
        var reader = function (readFile) { return new Promise(function (resolve, reject) {
            var fileReader = new FileReader();
            fileReader.onload = function () { return resolve(fileReader.result); };
            fileReader.readAsDataURL(readFile);
        }); };
        reader(file).then(function (result) { return setPropertyImage({ name: file === null || file === void 0 ? void 0 : file.name, url: result }); });
    };
            ...
            switch (_a.label) {
                case 0:
                    if (!propertyImage.name)
                        return [2 /*return*/, alert("Please upload a property image")];
    ...
    return (React.createElement(Form_1["default"], { type: "Edit", register: register, onFinish: onFinish, formLoading: formLoading, handleSubmit: handleSubmit, handleImageChange: handleImageChange, onFinishHandler: onFinishHandler, propertyImage: propertyImage }));
};
